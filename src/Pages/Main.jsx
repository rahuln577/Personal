export default function Main(props) {
    return <div className='w-full h-[100dvh] blac flex justify-center backdrop-blur-md items-center flex-col overflow-hidden'>
        ...
        <div className='w-full flex justify-between fixed top-0'><button className='text-white text-[1.3rem] sm:text-[1.8rem] p-[2rem]' onClick={props.clickanim}>About</button><button className='text-white text-[1.3rem] sm:text-[1.8rem] p-[2rem]'>Projects</button></div>
