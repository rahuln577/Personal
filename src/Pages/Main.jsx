export default function Main(props) {
    return <div className='w-full h-[100dvh] blac flex justify-center backdrop-blur-md items-center flex-col overflow-hidden'>
        ...
        <div className='w-full flex justify-between fixed top-0'><button className='text-white text-[1.3rem] sm:text-[1.8rem] p-[2rem]' onClick={props.clickanim}>About</button><button className='text-white text-[1.3rem] sm:text-[1.8rem] p-[2rem]' onClick={props.projclickanim}>Projects</button></div>
        <div className='mx-auto scale-[0.75] overflow-hidden z-[2]' id="herodiv">
            <p className='text-white font-fig text-[15vw] sm:text-[14vw] flex font-semibold overflow-hidden' id="hero1" ><span className='mr-[4vw]'>Hi</span><span>there &nbsp;!!</span></p>
            <div className='flex justify-between w-[95%] mx-auto my-[-5vw]' id="skill">
                <p className='text-gray-400 text-[4.5vw] sm:text-[2.5vw]'>MERN</p>
                <p className='text-gray-400 text-[4.5vw] sm:text-[2.5vw]'>C++</p>
            </div>
            <p className='text-white font-fig text-[15vw] sm:text-[14vw] flex items-center justify-center font-semibold' id="hero2"><span className='mr-[2vw]'>I</span> <span className='mr-[2vw]'>am</span> <span className='font-kalam mt-[3vw] text-white'>RAHUL</span></p>
        </div>
        <div className='w-full flex justify-between fixed bottom-0'><button className='text-white text-[1.3rem] sm:text-[1.8rem] p-[2rem] leading-wider'>Skills</button><button className='text-white text-[1.3rem] sm:text-[1.8rem] p-[2rem]'>Contact</button></div>
    </div>
}